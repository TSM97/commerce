          ...
          >
            {products?.map((product) => {
              return (
                <li
                  key={product?.id}
                  className='flex items-center justify-between px-1 rounded border border-transparent hover:border-t hover:border-t-transparent hover:border-r-transparent hover:border-l-transparent hover:border-b hover:border-honey hover:bg-primary-100'
                >
                  <div
